...
def create_normalized_template(image_path: str, troop_name: str, x: int, y: int,
                               w: int, h: int, target_width: int = 1080):
...
# Slot 5
#create_normalized_template(shop_path, "mother_witch", x=432, y=temp + 669, w=208, h=188)
# Slot 6
