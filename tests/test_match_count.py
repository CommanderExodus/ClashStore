...
class TestMatchCount(unittest.TestCase):
    ...
    def test_prefers_wider_template_over_narrower_prefix(self):
    ...
    def test_picks_best_score_within_same_width_group(self):
    ...
    def test_template_larger_than_search_zone_is_skipped(self):
        template = _random_pattern(60, 80, seed=1)
        self.analyzer.number_templates = {5: template}
